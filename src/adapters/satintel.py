...
class SatIntelAdapter(ReconAdapter):
    ...
    @staticmethod
    def _extract_gps_from_jpeg(filepath: Path) -> Optional[Tuple[float, float]]:
        """
    ...
    @staticmethod
    def _find_tag_in_ifd(data: bytes, ifd_offset: int, target_tag: int, endian: str) -> Optional[int]:
    ...
    @staticmethod
    def _parse_gps_ifd(data: bytes, gps_offset: int, endian: str) -> Optional[Tuple[float, float]]:
