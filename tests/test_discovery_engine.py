...
class TestEntityResolution:
    ...
    def test_same_business_record_links_push_cluster_confidence_above_threshold(self):
        ...
        pipeline = EntityResolutionPipeline(self.eng.db, self.eng._all_observables, self.eng._platform_from_url)
        pipeline._link_observables(fop, phone2, "same_business_record", 0.95)
        pipeline._link_observables(fop, ua, "same_business_record", 0.95)
